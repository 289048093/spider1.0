...
public class TradeApi {
    ...
    public TradeApi(String sessionKey){
     ...
     * @return
     */
    public Trade getTradeFullinfo(Map<String,Object> argsMap) throws Exception {
     ...
     * @return
     */
    public Trade getTrade(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Map<String,Object> getTradesSold(Map<String,Object> argsMap) throws Exception {
        // 创建保存卖家交易数据的map
        Map<String,Object> tradesSoldMap = new HashMap<String, Object>();
        // 交易数据请求
        ...
        tradesSoldMap.put(ConstantTaoBao.TOTAL_RESULTS,totalResults);
        tradesSoldMap.put(ConstantTaoBao.HAS_NEXT,hasNext);
        tradesSoldMap.put(ConstantTaoBao.TRADES,tradesTotal);

        TaoBaoLogUtil.logTaoBaoApi(response);
		return tradesSoldMap;
    }
     ...
     * @return
     */
    public Map<String,Object> getTradesSoldIncrement(Map<String,Object> argsMap) throws Exception {
        TradesSoldIncrementGetRequest req=new TradesSoldIncrementGetRequest();
        ReflectUtils.executeMethods(req,argsMap);

        // 创建保存卖家交易数据的map
        Map<String,Object> tradesSoldIncrementMap = new HashMap<String, Object>();
        // 搜索到的交易信息列表，返回的Trade和Order中包含的具体信息为入参fields请求的字段信息
        List<Trade> tradesTotal = new ArrayList<Trade>();
        // 搜索到的交易信息总数
        Long totalResults = 0L;
        ...
        tradesSoldIncrementMap.put(ConstantTaoBao.TOTAL_RESULTS,totalResults);
        tradesSoldIncrementMap.put(ConstantTaoBao.TRADES,tradesTotal);
        tradesSoldIncrementMap.put(ConstantTaoBao.HAS_NEXT,hasNext);

        TaoBaoLogUtil.logTaoBaoApi(response);
		return tradesSoldIncrementMap;
    }
