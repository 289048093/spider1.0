...
public class ProductApi {
     ...
     * @throws Exception
     */
    public Item itemUpdateListing(Map<String, Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public List<Item> getItemsCustom(Map<String, Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Product getProduct(Map<String, Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Item updateSkusQuantity(Map<String, Object> argsMap) throws Exception {
