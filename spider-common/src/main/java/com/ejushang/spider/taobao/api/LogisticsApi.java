...
public class LogisticsApi {
    ...
    public LogisticsApi(String sessionKey){
     ...
     * @throws Exception
     */
    public List<LogisticsCompany> getLogisticsCompanies(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Shipping sendLogisticsOffline(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Shipping confirmLogisticsOnline(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Shipping sendLogisticsOnline(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Map<String,Object> searchLogisticsTrace(Map<String,Object> argsMap) throws Exception {
        Map<String,Object> logisticsTraceMap = new HashMap<String, Object>();
        ...
        logisticsTraceMap.put(ConstantTaoBao.OUT_SID,response.getOutSid());
        logisticsTraceMap.put(ConstantTaoBao.COMPANY_NAME,response.getCompanyName());
        logisticsTraceMap.put(ConstantTaoBao.TID,response.getTid());
        logisticsTraceMap.put(ConstantTaoBao.STATUS,response.getStatus());
        logisticsTraceMap.put(ConstantTaoBao.TRACE_LIST,response.getTraceList());
        TaoBaoLogUtil.logTaoBaoApi(response);
        return logisticsTraceMap;
    }
