...
public class ShopApi {
    ...
    public ShopApi(String sessionKey){
     ...
     * @throws Exception
     */
    public Shop getShop(Map<String,Object> argsMap) throws Exception {
     ...
     * @throws Exception
     */
    public Shop updateShop(Map<String,Object> argsMap) throws Exception {
