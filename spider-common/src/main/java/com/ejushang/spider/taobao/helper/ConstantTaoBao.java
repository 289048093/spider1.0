...
public class ConstantTaoBao {
     ...
     * 使用OAuth2.0协议授权地址
     */
    public static final String TAOBAO_AUTHORIZE_URL = AppConfig.getInstance().getProperty("TAOBAO_AUTHORIZE_URL");
    /**
     * 使用OAuth2.0协议获取Access Token（即Session Key）地址
     */
    public static final String TAOBAO_TOKEN_URL = AppConfig.getInstance().getProperty("TAOBAO_TOKEN_URL");
    /**
     * 淘宝API访问地址
     */
    public static final String TAOBAO_API_URL = AppConfig.getInstance().getProperty("TAOBAO_API_URL");
    /**
     * 淘宝消息服务API访问地址
     */
    public static final String TAOBAO_MC_API_URL = AppConfig.getInstance().getProperty("TAOBAO_MC_API_URL");
    /**
     * 淘宝APP_KEY
     */
    public static final String APP_KEY = AppConfig.getInstance().getProperty("APP_KEY");
    /**
     * 淘宝APP_SECRET
     */
    public static final String APP_SECRET = AppConfig.getInstance().getProperty("APP_SECRET");

    /**
     * 平台类型
     */
    public static final String OUT_PLATFORM_TYPE = "TAOBAO";
