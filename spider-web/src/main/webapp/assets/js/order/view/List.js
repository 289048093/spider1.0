...
Ext.define('Supplier.view.List', {
    ...
    initComponent: function () {
        ...
        this.columns = [
            ...
            {text: '成交金额', dataIndex: 'payment', sortable: true, width: 80, xtype: 'numbercolumn', format:'0.00'},
            {text: '邮费', dataIndex: 'postFee', sortable: true, width: 80, xtype: 'numbercolumn', format:'0.00'},
